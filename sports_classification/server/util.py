...
def classify_image(image_base64_data, file_path=None):
    images = get_cropped_images_if_2_eyes(file_path, image_base64_data)
...
def get_cv2_image_from_base64_string(b64str):
    ...
    :return: Decoded image in OpenCV format
    """
...
def get_cropped_images_if_2_eyes(image_path, image_base64_data):
    face_cascade = cv2.CascadeClassifier('./artifacts/haar_cascade/haarcascade_frontalface_default.xml')
    eye_cascade = cv2.CascadeClassifier('./artifacts/haar_cascades/haarcascade_eye.xml')
